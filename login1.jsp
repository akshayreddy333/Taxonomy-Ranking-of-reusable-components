...
<body background="images/images.jpg">
  ...
  <h1>SOFTWARE COMPONENTS RETRIEVAL</h1>
  
  <div style="width: auto; max-width:780px; background-color: #FFffFF; border: 2px solid #0361A8; border-radius:5px; margin: 50px auto auto;">
